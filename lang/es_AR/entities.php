...
return [
    ...
    'recently_created_books' => 'Categorías recientemente creados',
    'recently_created_shelves' => 'Grupos recientemente creados',
    ...
    'permissions_book_cascade' => 'Los permisos establecidos en las categorías se aplicarán a sus capítulos y páginas, a menos que tengan sus propios permisos definidos.',
    ...
    'shelf' => 'Grupo',
    'shelves' => 'Grupos',
    'x_shelves' => ':count grupo|:count grupos',
    'shelves_empty' => 'No hay grupos creados',
    'shelves_create' => 'Crear grupo',
    'shelves_popular' => 'Grupos populares',
    'shelves_new' => 'Grupos nuevos',
    'shelves_new_action' => 'Nuevo grupo',
    'shelves_popular_empty' => 'Los grupos más populares aparecerán aquí.',
    'shelves_new_empty' => 'Los categorías más recientes aparecerán aquí.',
    'shelves_save' => 'Guardar grupo',
    'shelves_books' => 'Categorías en este grupo',
    'shelves_add_books' => 'Añadir categorías a este grupo',
    'shelves_drag_books' => 'Arrastra los categorías a continuación para añadirlas a este grupo',
    'shelves_empty_contents' => 'Este grupo no tiene categorías asignadas',
    'shelves_edit_and_assign' => 'Editar el grupo para asignar categorías',
    'shelves_edit_named' => 'Editar grupo :name',
    'shelves_edit' => 'Editar grupo',
    'shelves_delete' => 'Eliminar grupo',
    'shelves_delete_named' => 'Eliminar grupo :name',
    'shelves_delete_explain' => "Esto eliminará el grupo con el nombre ':name'. Las categorías que contenga no se eliminarán.",
    'shelves_delete_confirmation' => '¿Está seguro de que desea borrar este grupo?',
    'shelves_permissions' => 'Permisos del Grupo',
    'shelves_permissions_updated' => 'Permisos del grupo actualizados',
    'shelves_permissions_active' => 'Permisos del grupo activos',
    'shelves_permissions_cascade_warning' => 'Los permisos en los grupos no se aplican automáticamente a las categorías que contengan. Esto se debe a que una categoría puede existir en múltiples grupos. Sin embargo, los permisos pueden ser aplicados a las categorías del grupo utilizando la opción a continuación.',
    'shelves_permissions_create' => 'Los permisos de creación de grupos sólo se utilizan para copiar los permisos a las categorías contenidos utilizando la acción a continuación. No controlan la capacidad de crear categorías.',
    'shelves_copy_permissions_to_books' => 'Copiar permisos a las categorías',
    'shelves_copy_permissions' => 'Copiar permisos',
    'shelves_copy_permissions_explain' => 'Esto aplicará los permisos de este grupo para todos sus categorías. Antes de activarlo, asegúrese de que todos los cambios de permisos para este grupo han sido guardados.',
    'shelves_copy_permission_success' => 'Permisos del grupo copiados a :count categorías',

    // Books
    'book' => 'Categoría',
    'books' => 'Categorías',
    'x_books' => ':count Categoría|:count Categorías',
    'books_empty' => 'No hay categorías creadas',
    'books_popular' => 'Categorías populares',
    'books_recent' => 'Categorías recientes',
    'books_new' => 'Categorías nuevos',
    'books_new_action' => 'Nuevo Categoría',
    'books_popular_empty' => 'Las categorías más populares aparecerán aquí.',
    'books_new_empty' => 'Las categorías más recientes aparecerán aquí.',
    'books_create' => 'Crear nueva categoría',
    'books_delete' => 'Borrar categoría',
    'books_delete_named' => 'Borrar categoría :bookName',
    'books_delete_explain' => 'Esto borrará la categoría con el nombre \':bookName\', Todas las páginas y capítulos serán borrados.',
    'books_delete_confirmation' => '¿Está seguro de que desea borrar esta categoría?',
    'books_edit' => 'Editar Categoría',
    'books_edit_named' => 'Editar Categoría :bookName',
    'books_form_book_name' => 'Nombre de categoría',
    'books_save' => 'Guardar categoría',
    'books_permissions' => 'Permisos de la categoría',
    'books_permissions_updated' => 'Permisos de la categoría actualizados',
    'books_empty_contents' => 'Ninguna página o capítulo ha sido creada para esta categoría.',
    'books_empty_create_page' => 'Crear una nueva página',
    'books_empty_sort_current_book' => 'Organizar la categoría actual',
    'books_empty_add_chapter' => 'Agregar un capítulo',
    'books_permissions_active' => 'Permisos de la categoría activos',
    'books_search_this' => 'Buscar en esta categoría',
    'books_navigation' => 'Navegación de categoría',
    'books_sort' => 'Organizar contenido de categoría',
    'books_sort_desc' => 'Mueve capítulos y páginas dentro de una categoría para reorganizar su contenido. Se pueden añadir otras categorías lo que permite mover fácilmente capítulos y páginas entre categorías.',
    'books_sort_named' => 'Organizar categoría :bookName',
    ...
    'books_sort_show_other' => 'Mostrar otras categorías',
    'books_sort_save' => 'Guardar nuevo orden',
    'books_sort_show_other_desc' => 'Añada otras categorías aquí para incluirlos en la ordenación, y permita una fácil reorganización entre categorías.',
    'books_sort_move_up' => 'Subir',
    'books_sort_move_down' => 'Bajar',
    'books_sort_move_prev_book' => 'Mover a la categoría anterior',
    'books_sort_move_next_book' => 'Mover a la siguiente categoría',
    'books_sort_move_prev_chapter' => 'Mover al capítulo anterior',
    'books_sort_move_next_chapter' => 'Mover al siguiente capítulo',
    'books_sort_move_book_start' => 'Mover al inicio de la categoría',
    'books_sort_move_book_end' => 'Mover al final de al categoría',
    'books_sort_move_before_chapter' => 'Mover a antes del capítulo',
    'books_sort_move_after_chapter' => 'Mover a después del capítulo',
    'books_copy' => 'Copiar Categoría',
    'books_copy_success' => 'Categoría copiado correctamente',
    ...
    'chapter_sort_book' => 'Organizar Categoría',
    ...
    'book_tags' => 'Etiquetas de Categoría',
    'shelf_tags' => 'Etiquetas de Grupo',
    'tag' => 'Etiqueta',
    'tags' =>  'Etiquetas',
    ...
    'tags_assigned_books' => 'Asignadas a categorías',
    'tags_assigned_shelves' => 'Asignadas a grupos',
    ...
    'tags_list_empty_hint' => 'Las etiquetas se pueden asignar a través de la barra lateral del editor de páginas o mientras se editan los detalles de una categoría, capítulo o grupo.',
    ...
    'profile_not_created_books' => ':userName no ha creado ninguna categoría',
    'profile_not_created_shelves' => ':userName no ha creado ningún grupo',
    ...
    // Conversions
    'convert_to_shelf' => 'Convertir a Grupo',
    'convert_to_shelf_contents_desc' => 'Puedes convertir esta categoría a un nuevo grupo con el mismo contenido. Los capítulos contenidos en esta categoría se convertirán en categorías nuevos. Si esta categoría contiene alguna página, que no esté en un capítulo, esta categoría será renombrado y contendrá tales páginas, y esta categoría pasará a formar parte del nuevo grupo.',
    'convert_to_shelf_permissions_desc' => 'Cualquier permiso establecido en esta categoría será copiado al nuevo grupo y a todos los nuevas categorías que no tengan sus propios permisos configurados. Tenga en cuenta que los permisos de los grupos no se aplican automáticamente sobre el contenido en su interior, como lo hacen para las categorías.',
    'convert_book' => 'Convertir Categoría',
    'convert_book_confirm' => '¿Está seguro de que desea borrar esta categoría?',
    'convert_undo_warning' => 'Esto no puede revertirse de forma sencilla.',
    'convert_to_book' => 'Convertir a Categoría',
    'convert_to_book_desc' => 'Puede convertir este capítulo en un nueva categoría con el mismo contenido. Cualquier permiso establecido en este capítulo será copiado al nueva categoría pero cualquier permiso heredado, de la categoría padre, no se copiará lo que podría conducir a un cambio de control de acceso.',
    ...
    'watch_detail_parent_book' => 'Subscripciones por categoría contenedor',
    'watch_detail_parent_book_ignore' => 'Ignorando a través de la categoría contenedor',
